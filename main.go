...
import (
	...
	chclient "github.com/jpillora/chizzl/client"
	chserver "github.com/jpillora/chizzl/server"
	chshare "github.com/jpillora/chizzl/share"
	"github.com/jpillora/chizzl/share/ccrypto"
	"github.com/jpillora/chizzl/share/cos"
...
func generatePidFile() {
	...
	if err := os.WriteFile("chizzl.pid", pid, 0644); err != nil {
		log.Fatal(err)
	}
}
...
func server(args []string) {
	...
	if config.KeySeed != "" {
		log.Print("Option `--key` is deprecated and will be removed in a future version of chizzl.")
		log.Print("Please use `chizzl server --keygen /file/path`, followed by `chizzl server --keyfile /file/path` to specify the SSH private key")
	}
