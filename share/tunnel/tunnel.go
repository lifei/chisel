...
//Both chizzl client and server are Tunnels.
//chizzl client has a single set of remotes, whereas
//chizzl server has multiple sets of remotes (one set per client).
